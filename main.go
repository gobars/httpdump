...
func (o *Option) run() {
	...
	printer := util.NewRotateWriter(c, o.Output, o.OutChan, true)
	assembler := o.createAssembler(c, printer)
	util.LoopPackets(c, packets, assembler, o.Idle)

	printer.Wait()
}

func (o *Option) createAssembler(c context.Context, printer *util.RotateWriter) util.Assembler {
	switch o.Mode {
	case "fast", "pair":
		h := o.createConnectionHandler(printer)
		return newTCPAssembler(h, o.Chan, o.Ip, uint16(o.Port), o.Resp)
	default:
		return createTcpStdAssembler(c, o, printer)
	}
}
